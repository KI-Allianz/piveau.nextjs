...
function removeProtocol(uri: string): string {
...
export function useLicenses() {
  ...
  return {
    ...
    getLicenseOrUndefined: (licenseId?: string | null) =>
      context.licenses[removeProtocol(licenseId || "")],
    getLicense: (
      license?: {
        label?: string | null;
      ...
      context.licenses[license?.resource || ""] ||
      ({
