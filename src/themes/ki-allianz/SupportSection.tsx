      ...
      <div className="flex flex-col items-center bg-white dark:bg-black rounded-2xl px-10 pb-10 pt-16">
        <div className="max-w-2xl flex flex-col gap-5">
          <h2 className="text-4xl font-bold mb-2">
            Ein Ergebnis des Projektes "Datenplattform der KI-Allianz
            Baden-Württemberg"
          </h2>
          <p className="text-lg">
            ...
            Anwendung von Künstlicher Intelligenz (KI) zu fördern. Die Maßnahmen
            sollen dazu beitragen, Baden-Württemberg zu einem Hotspot der
            KI-Entwicklung und -Anwendung zu machen, bestehende Initiativen zu
            verbinden und die digitale Transformation überregional vernetzt
            voranzutreiben.
          </p>
        </div>
        ...
        <div className="max-w-sm">
          <Image
            ...
            width="800"
            height="398"
            src="/themes/ki-allianz/logo_bw-gefoerdert.svg"
